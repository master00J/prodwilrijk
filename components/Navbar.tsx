...
export default function Navbar() {
  ...
  const isCNHPage = 
    ...
    pathname.startsWith('/cnh/admin/airtec')
  ...
  useEffect(() => {
    ...
    if (isPrepackOpen || isAirtecOpen || isWoodOpen || isAdminOpen || isCNHOpen) {
  ...
  }, [isPrepackOpen, isAirtecOpen, isWoodOpen, isAdminOpen, isCNHOpen])
