...
export async function POST(request: NextRequest) {
  try {
    ...
    // Replace any existing order with this number (so we don't get duplicates in the time-registration list)
    ...
    console.error('Error uploading production order for time:', error)
    return NextResponse.json(
