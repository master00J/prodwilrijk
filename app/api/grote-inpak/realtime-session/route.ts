...
const TRANSCRIPTION_PROMPT = [
  ...
  'Belangrijke woorden: kisten, cases, caselabel, priority, prio, prioriteit, notitie, achterstand, Wilrijk, Genk, Willebroek, WLB, forecast, stock, transfer, productie.',
  'Voorbeelden: "hoeveel kisten lopen we achter uit Wilrijk", "zet KB91F op prio klant wacht", "welke cases hebben geen stock".',
