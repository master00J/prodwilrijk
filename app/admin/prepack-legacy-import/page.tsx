...
export default function PrepackLegacyImportPage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/admin/prepack-legacy-import', {
        method: 'POST',
        body: formData,
      })
  ...
  return (
    <AdminGuard>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-3xl font-bold mb-2">Prepack legacy import</h1>
        <p className="text-gray-600 mb-6">
          Upload de oude SQL dumps om de Prepack KPI’s terug te vullen.
        </p>
