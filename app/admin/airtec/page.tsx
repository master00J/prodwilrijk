...
export default function AirtecMonitorPage() {
  ...
  const handleExportExcel = () => {
    ...
    try {
      ...
      XLSX.utils.book_append_sheet(workbook, detailSheet, 'Kisten')

      const filename = `airtec-stats-${dateFrom || 'start'}-tot-${dateTo || 'eind'}.xlsx`
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <CollapsibleCard id="filters" title="Filters & KPI's">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              ...
              <div className="text-xs text-gray-500">Datum ontvangen → datum verpakt</div>
            </div>
            <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              ...
              <div className="text-lg font-semibold text-gray-900">
                {kpiStats.peakDay ? `${kpiStats.peakDay.itemsPacked} kisten` : '-'}
              </div>
              <div className="text-xs text-gray-500">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
        <CollapsibleCard id="chartOutput" title="Output & Manuren" subtitle="Kisten en manuren per dag">
          {loading ? (
          ...
          {loading ? (
            ...
            <ResponsiveContainer width="100%" height={260}>
              <ComposedChart data={dailyStats}>
                ...
                />
                <Line type="monotone" dataKey="itemsPerHour" stroke="#8b5cf6" strokeWidth={3} name="Items/uur" dot={false} />
              </ComposedChart>
            </ResponsiveContainer>
          )}
        </CollapsibleCard>
      ...
      <div className="grid grid-cols-1 gap-6 mb-6">
        <CollapsibleCard id="chartIncoming" title="Binnengekomen vs verpakt" subtitle="Goederen per dag">
          {loading ? (
            <div className="text-center py-8 text-gray-500">Grafiek laden...</div>
          ) : dailyStats.length === 0 ? (
            <div className="text-center py-8 text-gray-500">Geen data gevonden</div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Kistnummer</th>
